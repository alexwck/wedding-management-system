            ...
            weddings.slice(0, 5).map((wedding, i) => (
              ...
              >
                <div className="flex items-center gap-6">
                  ...
                  <p className="text-slate-400 text-sm font-mono">{wedding.wedding_date ? new Date(wedding.wedding_date).toLocaleDateString() : "No date"}</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className={`w-3 h-3 rounded-full ${wedding.template_image_url ? 'bg-emerald-400' : 'bg-amber-400'} animate-pulse`} />
                </div>
              </motion.div>
            ))
          )}
