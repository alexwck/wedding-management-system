...
Concise entry point for Claude Code in this repository. Keep this file small and
...
4. Keep `CLAUDE.md` and `AGENTS.md` synchronized when changing entry-point guidance.
